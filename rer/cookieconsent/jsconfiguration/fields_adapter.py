...
URL_MODEL = '<a href="{0}">{1}</a> '
pattern_link = re.compile(r'(\$privacy_link)(\s|$)')
pattern_link_url = re.compile(r'(\$privacy_link_url)(\s|$)')
pattern_link_text = re.compile(r'(\$privacy_link_text)(\s|$)')
